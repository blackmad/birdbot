...
def create_cairo_font_face_for_file(filename, faceindex=0, loadoptions=0):
    ...
    _freetype_so = ctypes.CDLL("/usr/local/lib/libfreetype.6.dylib")
    _cairo_so = ctypes.CDLL("/usr/local/lib/libcairo.2.dylib")
    ...
    if FT_Err_Ok != _freetype_so.FT_New_Face(_ft_lib, filename.encode("utf-8"), faceindex, ctypes.byref(ft_face)):
